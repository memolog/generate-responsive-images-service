...
function ImagePreview(props) {
    ...
    return preact_1.h("img", { src: src, className: "image-preview" });
}
    ...
    render() {
        return (preact_1.h("div", null,
            preact_1.h("form", null,
                preact_1.h("input", { type: "file", accept: "images/jpeg", id: "upload-image", onChange: this.onChangeHandler }),
                preact_1.h(ImagePreview, { src: this.state.imagePreviewSrc }),
                preact_1.h("button", { onClick: this.submitHandler }, "upload"))));
    }
}
