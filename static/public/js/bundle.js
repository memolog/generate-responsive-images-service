...
const responsiveImageList_1 = __webpack_require__(3);
...
function ImagePreview(props) {
    ...
    return preact_1.h("img", { src: src, style: { maxWidth: 350 } });
}
function LargeImagePreview(props) {
    ...
    return (preact_1.h("div", { style: blockStyle, onClick: props.closeHandler },
        preact_1.h("div", { style: containerStyle },
            preact_1.h("div", { style: imageContainerStyle },
                preact_1.h("div", null,
                    preact_1.h("img", { src: src.src, style: imageStyle })),
                preact_1.h("div", { style: linkContainerStyle },
                    preact_1.h("a", { onClick: props.closeHandler, style: linkStyle }, "Close"))))));
}
        ...
        return (preact_1.h("div", null,
            ...
            preact_1.h("div", { style: { maxWidth: 400, padding: '0 25px 25px', margin: '0 auto' } },
                preact_1.h("form", null,
                    ...
                    preact_1.h("button", { onClick: this.submitHandler, style: { display: 'block', margin: '1em 0' } }, "generate"))),
            preact_1.h(responsiveImageList_1.RespnsiveImageList, { images: this.state.images, clickHandler: this.showupLargeImage }),
            preact_1.h(LargeImagePreview, { src: this.state.responsiveImagePreviewSrc, closeHandler: this.closeLargeImage })));
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const preact_1 = __webpack_require__(0);
function RespnsiveImageList(props) {
    ...
    return (preact_1.h("div", { style: blockStyle },
        preact_1.h("ul", { style: listStyle }, imageElements)));
}
exports.RespnsiveImageList = RespnsiveImageList;
